...
<template>
  ...
  <div class="min-h-screen flex flex-col bg-gradient-to-b from-[#f5f6fa] to-[#e9ecf1] dark:from-[#0f0f0f] dark:to-[#1a1a1a] text-[#1b1b18] dark:text-[#EDEDEC]">
    ...
    <header class="w-full p-6 flex justify-between items-center backdrop-blur-md bg-white/40 dark:bg-black/20 border-b border-white/20 dark:border-[#3E3E3A]/40 fixed top-0 z-50">
      <h1 class="text-2xl font-extrabold tracking-tight">OSINT<span class="text-indigo-500">Analytics</span></h1>
    ...
    <!-- Hero Section -->
    <section class="flex flex-col items-center justify-center text-center pt-40 pb-24 px-6 lg:px-20 relative">
    ...
    <!-- Footer -->
    <footer class="w-full p-6 text-center border-t border-white/20 dark:border-[#3E3E3A]/40 text-sm text-gray-600 dark:text-gray-400">
